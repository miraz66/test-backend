...
export default function BodySvg({ className }) {
  return (
    <>
      <svg
        aria-hidden="true"
        className={
          "inset-0 -z-10 w-full fill-green-100 stroke-neutral-950/5 [mask-image:linear-gradient(to_bottom_left,white_50%,transparent_60%)] " +
          className
        }
      >
        <rect
